...
const LifeCorporate = () => {
  return (
    <Card>
      <CardHeader>
        <CardTitle tag='h1'>Life Corporate Member</CardTitle>
      </CardHeader>
          ...
          <Row>
            ...
            <Col>
              <FormGroup className='d-flex justify-content-center' >
                <Button.Ripple  className='mr-1' color='primary' type='submit'  onClick={LifeCorporate}>
                  Submit
                </Button.Ripple>
