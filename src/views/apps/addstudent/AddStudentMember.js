...
const AddStudentMember = () => {
  return (
    <Card>
      <CardHeader>
        <CardTitle tag='h1'>Student Member</CardTitle>
      </CardHeader>
      ...
      <CardBody>
        <Form>
          <Row>
            ...
            <Col md='6' sm='12'>
              <FormGroup>
                <Label for='CountryMulti'>Name of the Institute<span style={{color:'red', fontSize: 18}} >*</span></Label>
            ...
            <Col>
              <FormGroup className='d-flex justify-content-center' >
                <Button.Ripple  className='mr-1' color='primary' type='submit'  onClick={AddStudentMember}>
                  Submit
                </Button.Ripple>
...
export default AddStudentMember
