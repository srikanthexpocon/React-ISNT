    ...
    <Nav className='nav-left' pills vertical>
      ...
      <NavItem>
        <NavLink active={activeTab === '4'} onClick={() => toggleTab('4')}>
          ...
          <span className='font-weight-bold'>Address for Correspondence</span>
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink active={activeTab === '5'} onClick={() => toggleTab('5')}>
          <Bell size={18} className='mr-1' />
          <span className='font-weight-bold'>Permanent/Home/Alternate Address</span>
        </NavLink>
      </NavItem>
      <NavItem>
        <NavLink active={activeTab === '6'} onClick={() => toggleTab('6')}>
          <Bell size={18} className='mr-1' />
          <span className='font-weight-bold'>Membership Profile</span>
        </NavLink>
