...
const AppRoutes = [
  ...
  {
    path: '/apps/instructions',
    component: lazy(() => import('../../views/apps/instructions'))
  },
 
  {
    path: '/apps/announcement',
    component: lazy(() => import('../../views/apps/announcement'))
  },
  ...
  {
    path: '/apps/associatemember',
    component: lazy(() => import('../../views/apps/associatemember'))
  },

  {
    path: '/apps/addstudent',
    component: lazy(() => import('../../views/apps/addstudent'))
  },

  {
    path: '/apps/corporatemember',
    component: lazy(() => import('../../views/apps/corporatemember'))
  },

  {
    path: '/apps/lifecorporate',
    component: lazy(() => import('../../views/apps/lifecorporate'))
  },

  {
    path: '/apps/addmember',
    component: lazy(() => import('../../views/apps/addmember'))
  },
  
  {
    path: '/apps/lifemember',
    component: lazy(() => import('../../views/apps/lifemember'))
  },

  {
    path: '/apps/fellowmember',
    component: lazy(() => import('../../views/apps/fellowmember'))
  },
